...
# install wallpapers
mkdir -p "${destination}"/usr/share/backgrounds/armbian-sddm/
cp "${SRC}"/packages/blobs/desktop/lightdm-wallpapers/*.jpg "${destination}"/usr/share/backgrounds/armbian-sddm
